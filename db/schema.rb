...
ActiveRecord::Schema[7.0].define(version: 2023_08_15_132524) do
  ...
  create_table "category_expenses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["author_id"], name: "index_category_expenses_on_author_id"
  ...
  add_foreign_key "category_expenses", "users", column: "author_id"
